...
^ -m *****.v3draw  -p r+f -o Registration_sample_data/result/user_data/ -d 30

mBrainAligner_data\3rdparty_windows\local_registration.exe -p Registration_sample_data/Parameter/mouse_brain_initial_config.txt -s Registration_sample_data/result/user_data/global.v3draw ^
^ -l mBrainAligner_data/data/density_landmarks/low_landmarks.marker  -g mBrainAligner_data/data/ -o Registration_sample_data/result/user_data/
