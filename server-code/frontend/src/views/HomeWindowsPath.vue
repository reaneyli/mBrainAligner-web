...
export default {
  ...
  data() {
    return {
      ...
      // ////////////////////////////////////////////////////////////////
      globalExeFix:
        "mBrainAligner_data\\3rdparty_windows\\global_registration.exe", //exe 命令
      globalFFix:
        "-f mBrainAligner_data/data/average_template_25_u8_xpad.v3draw", //global F
      globalCFix: "-c mBrainAligner_data/data/recentered_image_pad_scr.v3draw", // global c
      globalMFixSample: {
        fMOST:
          "-m Registration_sample_data/raw_sample_data/fMOST_18458_raw.v3draw",
        LSFM: "-m Registration_sample_data/raw_sample_data/LSFM_raw.v3draw",
        MRI: "-m Registration_sample_data/raw_sample_data/MRI_raw.v3draw",
        VISoR: "-m Registration_sample_data/raw_sample_data/VISoR_raw.v3draw",
      }, // global m sample
      globalMFixUserVarible:
        "-m mBrainAligner_data\\3rdparty_windows\\user_upload", // 上传xx.v3draw文件的路径变量
      globalMFixUser: "",
      globalOSample: {
        fMOST: "-o Registration_sample_data/user_sample_result/fMOST",
        LSFM: "-o Registration_sample_data/user_sample_result/LSFM",
        MRI: "-o Registration_sample_data/user_sample_result/MRI",
        VISoR: "-o Registration_sample_data/user_sample_result/VISoR",
      },
      globalOUserVariable:
        "-o mBrainAligner_data\\3rdparty_windows\\user_result", //global user 输出路径变量
      globalOUser: "", // global user 输出路径最终值

      /////////////////////// global end ////////////////////////////////
      //////////////////////// local start ///////////////////
      localExeFix:
        "mBrainAligner_data\\3rdparty_windows\\local_registration.exe", // local exe
      localGFix: "-g mBrainAligner_data/data/", // local g
      localPSample: {
        fMOST: "-p Registration_sample_data/Parameter/fMOST_config.txt",
        LSFM: "-p Registration_sample_data/Parameter/LSFM_config.txt",
        MRI: "-p Registration_sample_data/Parameter/MRI_config.txt",
        VISoR: "-p Registration_sample_data/Parameter/VISoR_config.txt",
        define:
          "-p Registration_sample_data/Parameter/mouse_brain_initial_config.txt", //用户自定义参数生成的config
      }, //local p
      localPUser:
        "-p Registration_sample_data/Parameter/mouse_brain_initial_config.txt",
      localMSample: {
        fMOST: "-m Registration_sample_data/fMOST_segmentation/",
        LSFM: "",
        MRI: "",
        VISoR: "",
      }, // local m
      localSSample: {
        fMOST: "-s Registration_sample_data/user_sample_result/fMOST",
        LSFM: "-s Registration_sample_data/user_sample_result/LSFM",
        MRI: "-s Registration_sample_data/user_sample_result/MRI",
        VISoR: "-s Registration_sample_data/user_sample_result/VISoR",
      }, // local s
      localLFix: {
        low: "-l mBrainAligner_data/data/density_landmarks/low_landmarks.marker",
        middle:
          "-l mBrainAligner_data/data/density_landmarks/middle_landmarks.marker",
        high: "-l mBrainAligner_data/data/density_landmarks/high_landmarks.marker",
      }, // local l
      localOSample: {
        fMOST: "-o Registration_sample_data/user_sample_result/fMOST",
        LSFM: "-o Registration_sample_data/user_sample_result/LSFM",
      ...
      localSUserVariable:
        "-s mBrainAligner_data\\3rdparty_windows\\user_result",
      //////////////////////// local end ///////////////////
  ...
  methods: {
    ...
    handleSuccess(rep, file, fileList) {
      ...
      // let fileTitle = this.currentUploadImg.substring(-1, 5);
    ...
    checkDownloadStatus() {
      ...
      let timer = setInterval(function () {
        api
          ...
          .catch((err) => {
            console.log("download test err:", err);
          });
      }, 5000);
    },
  },
